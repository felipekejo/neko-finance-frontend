  ...
  return (
    <section className="sticky left-0 top-0 flex h-screen w-fit flex-col  justify-between border-r pt-8 max-md:hidden sm:p-4 xl:p-6 2xl:w-[355px]">
      <nav className="flex flex-col gap-4">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 py-1 rounded-lg justify-center"
        >
        ...
        >
          <div className="flex items-center gap-2 justify-center">
            <CircleDollarSign className="text-lg" />
            <p className="text-lg">My Accounts</p>
          </div>
        </Link>
        <Link
          href="/"
        ...
        >
          <div className="flex items-center gap-2 justify-center">
            <ChartNoAxesCombined className="text-lg" />
            <p className="text-lg">Charts</p>
          </div>
        </Link>
      </nav>
      FOOTER
